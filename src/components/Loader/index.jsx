const Loader = ({type}) => {
  ...
  // eğerki type değeri headera eşit ise headerın loaderını return et değilse diğer loader
 if(type==="header") 
  return (
 <div data-testid="header-loader" className="flex items-center space-x-2 animate-pulse text-gray-700">
 ...
 // map ile dönebilmek için 16 elemana sahip bir dizi oluştur 
 const arr = new Array(16).fill();
  ...
  <h2 className="bg-gray-300 w-3/4 text-lg font-bold rounded-md select-none">.</h2>
